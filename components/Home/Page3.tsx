    ...
    <div className="w-full h-full relative">
      ...
      <div className="w-full h-screen absolute overflow-hidden top-0 left-0">
        <div className="h-full relative">
          <div className="w-full absolute top-0 left-0 h-[70px] md:h-[90px] flex justify-center py-3 px-5 md:px-10">
            <Image
              unoptimized
          ...
          <div className="flex flex-col gap-5 md:hidden w-full h-fit top-[120px] absolute">
            ...
            <div className="w-full h-full flex items-center justify-center z-10">
              <div className="flex flex-col gap-2">
                ...
                <div className="w-full flex item justify-center gap-3">
                  <Link
                    href={"/info"}
                    className="bg-white text-black w-fit px-3 md:px-5 py-2 rounded-lg text-xs md:text-sm"
                  >
                    Ver mas
                  </Link>
                </div>
          ...
          <div className=" w-full h-screen flex items-end justify-center">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-5 relative h-full w-full">
              ...
              <div className="hidden md:flex flex-col gap-5 justify-center items-center">
                <h1 className="tracking-tight uppercase font-extrabold text-4xl lg:text-5xl text-center leading-tight bg-gradient-to-t from-[#FC228A] to-[#FF9900] bg-clip-text text-transparent">
                  62 años de historia
                </h1>
